      ...
      >
        ...
        <div className="p-6 border-b border-zinc-800/50 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <LuHistory className="w-5 h-5 text-retro-primary" />
        ...
        <div className="flex-1 overflow-y-auto scrollbar-thin p-6">
          {stats.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-12 text-zinc-600">
              <LuHistory className="w-12 h-12 mb-4 opacity-50" />
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-4 gap-4">
                ...
                >
                  <LuGamepad2 className="w-5 h-5 text-retro-primary mx-auto mb-2" />
                ...
                <motion.div
                  ...
                  className="glass rounded-xl p-4 text-center"
                >
                  <LuShieldCheck className="w-5 h-5 text-retro-secondary mx-auto mb-2" />
                ...
                <motion.div
                  ...
                  className="glass rounded-xl p-4 text-center"
                >
                  <LuCircleCheckBig className="w-5 h-5 text-retro-success mx-auto mb-2" />
                ...
                <motion.div
                  ...
                  className="glass rounded-xl p-4 text-center"
                >
                  <LuCircleX className="w-5 h-5 text-retro-danger mx-auto mb-2" />
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <LuGamepad2 className="w-5 h-5 text-retro-primary" />
                    ...
                    <div className="grid grid-cols-4 gap-4">
                      <div className="flex items-center gap-2">
                        <LuGamepad2 className="w-4 h-4 text-retro-primary" />
                        <div>
                      ...
                      <div className="flex items-center gap-2">
                        <LuShieldCheck className="w-4 h-4 text-retro-secondary" />
                        <div>
                      ...
                      <div className="flex items-center gap-2">
                        <LuCircleCheckBig className="w-4 h-4 text-retro-success" />
                        <div>
                      ...
                      <div className="flex items-center gap-2">
                        <LuCircleX className="w-4 h-4 text-retro-danger" />
                        <div>
